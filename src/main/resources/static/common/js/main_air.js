...
$(document).ready(function() {
    ...
    let isSelectedOption = 0;
    function originAirport() {
        console.log('함수 : '+isSelectedOption);
        if(isSelectedOption === 1) return false;
        if (input.val().trim() !== "") {
    ...
    input.on('keyup', function() {
        console.log('input : '+isSelectedOption);
